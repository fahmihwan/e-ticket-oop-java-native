...
public class TrainServiceImpl implements TrainService {
	...
	@Override
	public List<Schedule> findTrainSchedule() {

		final List<Schedule> listSchedule = new ArrayList<>();
		
		final Schedule malabar = new Schedule();
		malabar.setScheduleId(1);
		malabar.setName("Malabar");
		malabar.setDate("16 Juni 2023");
		malabar.setFrom("Jakarta");
		malabar.setTo("Bandung");
		malabar.setPrice(100000);
		listSchedule.add(malabar);
		
		final Schedule probowangi = new Schedule();
		probowangi.setScheduleId(2);
		probowangi.setName("Probowangi");
		probowangi.setDate("17 Juni 2023");
		probowangi.setFrom("Jakarta");
		probowangi.setTo("Surabaya");
		probowangi.setPrice(200000);
		listSchedule.add(probowangi);
		
		final Schedule sritanjung = new Schedule();
		sritanjung.setScheduleId(3);
		sritanjung.setName("Sri Tanjung");
		sritanjung.setDate("18 Juni 2023");
		sritanjung.setFrom("Jakarta");
		sritanjung.setTo("Yogyakarta");
		sritanjung.setPrice(300000);
		listSchedule.add(sritanjung);
	
		final Schedule mataram = new Schedule();
		mataram.setScheduleId(4);
		mataram.setName("Mataram");
		mataram.setDate("19 Juni 2023");
		mataram.setFrom("Jakarta");
		mataram.setTo("Malang");
		mataram.setPrice(400000);
		listSchedule.add(mataram);
		
		final Schedule mojosari = new Schedule();
		mojosari.setScheduleId(5);
		mojosari.setName("Mojosari");
		mojosari.setDate("20 Juni 2023");
		mojosari.setFrom("Jakarta");
		mojosari.setTo("Semarang");
		mojosari.setPrice(500000);
		listSchedule.add(mojosari);
		
		final Schedule kahuripan = new Schedule();
		kahuripan.setScheduleId(6);
		kahuripan.setName("Kahuripan");
		kahuripan.setDate("21 Juni 2023");
		kahuripan.setFrom("Jakarta");
		kahuripan.setTo("Balikpapan");
		kahuripan.setPrice(600000);
		listSchedule.add(kahuripan);
		
		final Schedule gajayana = new Schedule();
		gajayana.setScheduleId(7);
		gajayana.setName("Gajayana");
		gajayana.setDate("22 Juni 2023");
		gajayana.setFrom("Jakarta");
		gajayana.setTo("Bali");
		gajayana.setPrice(700000);
		listSchedule.add(gajayana);
		
		final Schedule pasarminggu = new Schedule();
		pasarminggu.setScheduleId(8);
		pasarminggu.setName("Pasar Minggu");
		pasarminggu.setDate("23 Juni 2023");
		pasarminggu.setFrom("Jakarta");
		pasarminggu.setTo("Papua");
		pasarminggu.setPrice(800000);
		listSchedule.add(pasarminggu);
		
		final Schedule manggarai = new Schedule();
		manggarai.setScheduleId(9);
		manggarai.setName("Manggarai");
		manggarai.setDate("24 Juni 2023");
		manggarai.setFrom("Jakarta");
		manggarai.setTo("Samarinda");
		manggarai.setPrice(900000);
		listSchedule.add(manggarai);
		
		final Schedule laboan = new Schedule();
		laboan.setScheduleId(10);
		laboan.setName("Laboan");
		laboan.setDate("25 Juni 2023");
		laboan.setFrom("Jakarta");
		laboan.setTo("Malaysia");
		laboan.setPrice(1000000);
		listSchedule.add(laboan);
	...
	@Override
	public List<Chair> findTrainChair(int input) {
